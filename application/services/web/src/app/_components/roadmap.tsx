...
export const Roadmap = () => (
  ...
  >
    ...
    >
      <div
        className="text-[#354AEB] font-black text-[2.8rem] 
      ...
      <div
        className="text-[#FF222E] font-black text-[2.8rem] 
      ...
      />
      <div />
      <div className="text-white/80 font-bold text-[2rem]">Step 1</div>
      <div className="text-white/80 font-bold text-[2rem]">Step 2</div>
      <div className="text-white/80 font-bold text-[2rem]">Step 3</div>
      <div className="text-white/80 font-bold text-[2rem]">Step 4</div>
      <div />
    </div>
